...
exports.EnrollmentModule = EnrollmentModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([enrollment_entity_1.Enrollment, assignment_submission_entity_1.AssignmentSubmission, user_entity_1.User, course_entity_1.Course]),
            notification_module_1.NotificationModule,
            certificate_module_1.CertificateModule
        ],
        controllers: [enrollment_controller_1.EnrollmentController],
        providers: [enrollment_service_1.EnrollmentService, email_service_1.EmailService],
