        ...
        try {
            ...
            for (const user of allUsers) {
                try {
                    ...
                    console.error(...oo_tx(`272834691_401_10_401_33_11`, errorMsg));
                }
            }
            return {
            ...
            console.error(...oo_tx(`272834691_412_6_412_75_11`, 'Failed to create notifications for all users:', error));
            return {
                success: false,
                totalUsers: 0,
                emailsSent: 0,
        ...
        try {
            ...
            for (const enrollment of enrollments) {
                ...
                if (!student) {
                    ...
                    errors.push(errorMsg);
                    console.error(...oo_tx(`272834691_478_10_478_33_11`, errorMsg));
                    continue;
                }
                try {
                    ...
                    errors.push(errorMsg);
                    console.error(...oo_tx(`272834691_507_10_507_33_11`, errorMsg));
                }
            }
            return {
                success: emailsSent > 0,
            ...
            console.error(...oo_tx(`272834691_518_6_518_78_11`, 'Failed to send notifications to course students:', error));
            return {
                success: false,
                totalStudents: 0,
                emailsSent: 0,
    ...
    async sendNotificationToCourseStudent(courseId, studentId, title, message, metadata) {
        try {
            ...
            try {
                ...
                const errorMsg = `Failed to send notification to student ${student.id} (${student.email}): ${error.message}`;
                console.error(...oo_tx(`272834691_611_8_611_31_11`, errorMsg));
                return {
                    success: false,
                    emailSent: false,
                    error: errorMsg
            ...
            console.error(...oo_tx(`272834691_619_6_619_76_11`, 'Failed to send notification to course student:', error));
            return {
                success: false,
                emailSent: false,
                error: error.message
    ...
    async sendNotificationEmail(notification) {
        try {
            ...
            if (!notificationWithRecipient || !notificationWithRecipient.recipient) {
                console.error(...oo_tx(`272834691_637_8_637_78_11`, 'Notification or recipient not found for email sending'));
                return;
            }
            ...
            console.error(...oo_tx(`272834691_654_6_654_64_11`, 'Failed to send notification email:', error));
        }
    }
