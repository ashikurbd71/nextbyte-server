...
let EnrollmentService = class EnrollmentService {
    ...
    async create(createEnrollmentDto) {
        ...
        try {
            ...
            console.error(...oo_tx(`3810779725_101_6_101_67_11`, 'Failed to send welcome email:', error.message));
        }
    ...
    async handleSslCommerzSuccess(transactionData) {
        ...
        try {
            ...
            console.error(...oo_tx(`3810779725_280_6_280_67_11`, 'Failed to send welcome email:', error.message));
        }
    ...
    async updateProgress(enrollmentId, progress) {
        ...
        if (enrollment.progress >= 100 && enrollment.status !== enrollment_entity_1.EnrollmentStatus.COMPLETED) {
            ...
            try {
                ...
                console.error(...oo_tx(`3810779725_417_8_417_85_11`, 'Failed to generate certificate automatically:', error.message));
            }
        }
        return await this.enrollmentRepository.save(enrollment);
    }
